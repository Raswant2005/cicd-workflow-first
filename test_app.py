import pytest
from app import add1, div1, Company
...
def test_add_employee(company):
    ...
    with pytest.raises(ValueError,
                       match="Employee with this ID already exists"):
        company.add_employee(1, "Jane Doe")


def test_get_employee_not_exists(company):
    with pytest.raises(ValueError,
                       match="Employee with this ID does not exist"):
